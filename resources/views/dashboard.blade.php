@extends('layouts.app')
@section('title', 'Hawkins Mail v.32')
            ...
            <div class="toolbar-left">
                <div class="search-toolbar">
                    <div class="search-wrap" style="flex:1">
                        ...
                        <input type="search" id="search-input" class="search-input" placeholder="Buscar por asunto, remitente o contenido..." autocomplete="off" data-lpignore="true" data-form-type="other">
                    </div>
...
@push('scripts')
<script src="/js/mail.js?v=30"></script>
@endpush
